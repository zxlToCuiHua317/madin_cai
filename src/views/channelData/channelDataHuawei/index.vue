<template>
  <div class="app-container">
    ...
    <div class="head-container">
      ...
      <!--表格渲染-->
      <el-table ref="table" v-loading="crud.loading" border :data="crud.data" size="small" style="width: 100%;" :default-sort="{ order: 'descending'}" @sort-change="sortData" @selection-change="crud.selectionChangeHandler">
